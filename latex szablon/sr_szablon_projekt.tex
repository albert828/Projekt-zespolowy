...
\newcommand{\projectname}{Złożone urządzenie ogólnorozwojowe}
...
\newcommand{\osobaE}{Michał \textsc{Moruń}, xxx}
\newcommand{\osobaB}{Paula \textsc{Langkafel}, xxx}
\newcommand{\osobaA}{Krzysztof \textsc{Kurnik}, xxx}
\newcommand{\osobaD}{Maciej \textsc{Marszałek}, xxx}
