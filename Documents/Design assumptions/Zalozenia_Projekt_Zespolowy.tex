...
Daty mogą ulec zmianie przy porozumieniu z prowadzącym.
\subsubsection{03.04 Wymagania użytkownika i założenia}
\begin{enumerate}
\item 27.03 Zebranie badań dotyczących ergonomii
\item 27.03 Wyszczególnienie najważniejszych współczynników
\item 03.04 Określenie zakresu współczynników
\item 03.04 Wybranie odpowiedniej formy zachowania się w przypadku przekroczenia dopuszczalnej wartości
\end{enumerate}
\subsubsection{15.05 Projekt, implementacja komponentów i systemu}
\begin{enumerate}
\item 10.04 Podłączenie i oprogramowanie czujnika:
	\begin{description}[font=$\bullet$~\normalfont]
	...
	\item hałasu
	\end{description}
\item 10.04 Stworzenie logiki w oparciu o ustalone zakresy
\item 17.04 Dodanie sygnalizacji na ekranie OLED
\item 17.04 Podłączenie i oprogramowanie modułu WiFi ESP8266
\item 01.05 Back-end
	\begin{enumerate}
